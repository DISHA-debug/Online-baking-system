...
<table border="2"> 
<caption><h2>BALANCE RECORDS</h2></caption><br>
<tr>
...
<th style="width:5%">MONEY DEPOSITED</th>
<th style="width:5%">MONEY WITHDRAWED</th>
<th style="width:5%">TOTAL BALANCE</th>
<th style="width:5%">AMOUNT TRANSFERRED</th>
...
<td><c:out value="${table.transferredamount}"/></td>
