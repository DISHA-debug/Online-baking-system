...
select deposittable.fname,deposittable.idcard,newacc.amount as amount, deposittable.withdrawamount as withamount, newacc.amount-deposittable.withdrawamount as totalamount   
 from newacc 
