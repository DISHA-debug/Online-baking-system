...
<div><%if(request.getAttribute("balance")!=null)
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div><hr>
			 <center><a href="deposit.jsp"><b>ADD AMOUNT TO YOUR SAVINGS ACCOUNT</b></a></center><hr>
				<form name=F1 onSubmit="return dil(this)" action="<%=request.getContextPath()%>/viewsavings.jsp" >
				 <fieldset>
    <legend>VIEW YOUR SAVINGS:</legend>
				  ...
				  <tr><td>ID CARD NUMBER:</td><td> <input type="text" name="idcard" placeholder="Enter your id card no"/></td></tr>
					...
					<tr><td>ACCOUNT TYPE:</td><td> <input type="text" name="acctype" placeholder="Savings"/></td></tr>
