...
password="2548"></sql:setDataSource> <sql:query var="display" dataSource="${connection}">
SELECT * FROM newacc where idcard="${param.idcard}";
</sql:query>
<c:forEach var="table" items="${display.rows}">  
<center><h1>Welcome To The World of Online Banking ${table.fname} !!</h1></center>
