...
<td>
<center><a href="viewwithupdate.jsp">View Your Updated Details</a></center>
<form name=F1 onSubmit="return dil(this)" method="get" action="<%=request.getContextPath()%>/with1.jsp" >
	 <fieldset>
    <legend>WITHDRAW FORM:</legend>
				  <table cellspacing="5" cellpadding="3">	
                    ...
                    <tr><td>WITHDARW AMOUNT:</td><td> <input type="text" name="withdrawamount"/></td></tr>
